...
To serialize data, use WriteTo.

To recover the typed value of a byte sequence previously generated by WriteTo,
use ReadFrom.
...
Serialized data doesn't contain type information.
It's up to the programmer to ensure that recovery is performed by an
encoder created
after the same type kind of the encoder that generated the serialized data.
...
WriteTo writes to an io.Writer a sequence of bytes
representing the contents of the placeholder variable.
Returns the number of bytes written.

ReadFrom reads from an io.Reader a sequence of bytes
previously generated by WriteTo
